...
import ru.diplomnaya.skilllcinema.databinding.CustomDataPickerBinding
...
class YearPickerFragment: Fragment() {
    private var _binding: CustomDataPickerBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = CustomDataPickerBinding.inflate(inflater)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
                val list_years=requireArguments().getStringArrayList(KEY_YEAR_ARRAY)
    ...
    private fun addChip(yearValueString:String){
        ...
        simpleChip.setOnClickListener {
                  if( yearMap.contains(yearValueString)){
                      ...
                      SettingsYearsFragment.TemporalValueOfYear.yearFromTemporale=year!!
                  }
                }

        binding.chipGroup.addView(simpleChip)

    }
    companion object {

        private const val KEY_YEAR_ARRAY = "year_array"

        fun newInstance(
        year_array: ArrayList<String>,

            ): YearPickerFragment {
            return YearPickerFragment().putArguments {
                    putStringArrayList (KEY_YEAR_ARRAY,year_array)
